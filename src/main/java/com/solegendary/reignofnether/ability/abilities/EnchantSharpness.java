...
public class EnchantSharpness extends EnchantAbility {
    ...
    public AbilityButton getButton(Keybinding hotkey) {
        return new AbilityButton(
                ...
                List.of(
                        ...
                        FormattedCharSequence.forward("Enchant a Vindicator's axe with sharpness, ", Style.EMPTY),
    ...
    protected boolean hasSameEnchant(LivingEntity entity) {
        return entity.getItemBySlot(EquipmentSlot.MAINHAND).getAllEnchantments().containsKey(Enchantments.SHARPNESS);
    }

    @Override
    protected void doEnchant(LivingEntity entity) {
        entity.getItemBySlot(EquipmentSlot.MAINHAND).enchant(Enchantments.SHARPNESS, 1);
    }
}
